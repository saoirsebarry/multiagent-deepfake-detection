"""Retrain the visual XceptionNet agent from ImageNet weights with the released two-stage
recipe (head-only epochs at 1e-3, then unfreeze from block 11 for OneCycle epochs at 1e-5
